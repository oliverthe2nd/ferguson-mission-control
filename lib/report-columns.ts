...
export const REPORT_COLUMNS: Record<EditableReportType, ReportColumn[]> = {
  enrolment_milestones: [
    ...
    { key: "registration_date", label: "Date Registered", type: "date" },
    { key: "m1_target", label: "M1 Target — First Consult Fee", type: "date" },
    { key: "m1_actual", label: "M1 Actual — First Consult Fee", type: "date" },
    { key: "m2_target", label: "M2 Target — Tuition Fee", type: "date" },
    { key: "m2_actual", label: "M2 Actual — Tuition Fee", type: "date" },
    { key: "m3_target", label: "M3 Target — Visa Lodgement Fee", type: "date" },
    { key: "m3_actual", label: "M3 Actual — Visa Lodgement Fee", type: "date" },
    { key: "m4_target", label: "M4 Target — OSHC Fee", type: "date" },
    { key: "m4_actual", label: "M4 Actual — OSHC Fee", type: "date" },
    { key: "m5_target", label: "M5 Target — Second Consult Fee", type: "date" },
    { key: "m5_actual", label: "M5 Actual — Second Consult Fee", type: "date" },
  ],
  visa_lodgement: [
